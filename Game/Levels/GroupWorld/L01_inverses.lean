...
Introduction "
It's more common to think of a group as bulding on a monoid structure and that's the approach we'll take in this level.
...
The goal of this level is to use these axioms to prove a simple identity and to add them to your inventory.
"
